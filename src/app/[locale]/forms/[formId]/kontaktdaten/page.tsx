...
export default async function KontaktdatenPage({ params, searchParams }: KontaktdatenPageProps) {
  ...
  return (
    <GenericWizardForm
      ...
      formId={formId}
      initialValues={draft?.pageData["kontaktdaten"]}
